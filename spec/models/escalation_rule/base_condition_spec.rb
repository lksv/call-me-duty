...
RSpec.describe EscalationRule::BaseCondition, type: :model do
  let(:incident) do
    double('Incident Instance', resolved?: false, snoozed?: false)
  end

  subject { EscalationRule::BaseCondition.new(incident) }
